# ada-projeto_1
## Técnicas da Progamação (Python)
Repositório do curso Técnicas de Programação (Python), parte da trilha Analista de Dados.

##Sobre o curso
Este curso apresenta as principais ferramentas usadas nop trabalho diário com dados em Python, com foco em prática e construção de
portfólio. O conteúdo está organizado em cinco aulas, complementadas por um projeto final em grupo.
